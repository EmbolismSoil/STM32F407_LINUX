...
static void SPI_Config(void)
{
  ...
  SPI_InitStructure.SPI_CPOL = SPI_CPOL_Low;		/*空闲时时钟总线为低电平*/
  SPI_InitStructure.SPI_CPHA = SPI_CPHA_1Edge;		/*第一个时钟跳变沿时对数据进行采样*/
  SPI_InitStructure.SPI_NSS = SPI_NSS_Soft;			/*软件管理从器件片选*/
